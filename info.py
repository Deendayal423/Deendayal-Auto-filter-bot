...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001822165826').split()]
...
URL = "https://advanceautofilter-84e868d5eeb7.herokuapp.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://advanceautofilter-84e868d5eeb7.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://advanceautofilter-84e868d5eeb7.herokuapp.com/".format(FQDN)
else:
    URL = "https://advanceautofilter-84e868d5eeb7.herokuapp.com/".format(FQDN)
